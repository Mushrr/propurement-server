...
function hasProperties(obj: object, properties: string[]): boolean {
    return (
        obj && properties.every((prop) => Object.hasOwnProperty.call(obj, prop))
    );
}
 ...
 */
function objectToMongoUpdateSchema(
    obj: object,
...
function getMetaType(path: PathLike) {
    ...
    const extension: keyof typeof metaTypeMapping = (pathStr.split(".").pop() ||
        "default") as keyof typeof metaTypeMapping;
